...
export class MissingWordGame extends Game {
    ...
    loadSentences() {
        ...
        wordsWithSentences.forEach(word => {
            ...
            const modifiedSentence = selectedSentence.replace(new RegExp(`(?<!\\w)${word.text}(s|[.,!?])?(?!\\w)`, 'gi'), "________");
    ...
    organizeWordsByPage() {
        ...
        for (let pageIndex = 0; pageIndex < totalPages; pageIndex++) {
            ...
            for (const wordEl of wordsOnPage) {
                ...
                const matchingSentence = translationElements.find(sentenceEl => sentenceEl.dataset.selectedWord === wordText);
                if (matchingSentence) {
        ...
        if (sentences.length > 0) {
            ...
            if (!hasMatchingWord && selectedWord) {
                ...
                if (matchingSentence) {
                    ...
                    const newSentence = matchingSentence.cloneNode(true);
